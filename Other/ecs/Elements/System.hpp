...
namespace ecs
{
    namespace Impl
    {
        // A system is an optional syntactic-sugar abstraction over signature
        // entity matching.
        template <typename TManager, template <typename> class TDerived,
            typename TSignature>
        ...
        public:
            ...
            auto& getManager() noexcept { return *manager; }
