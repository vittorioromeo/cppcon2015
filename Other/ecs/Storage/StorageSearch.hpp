...
namespace ecs
{
    namespace Impl
    {
        ...
        template <typename TComponentsTypeList, typename TCurrentStorage,
            typename... TRestStorages>
        struct StorageSearch<TComponentsTypeList, TCurrentStorage,
            TRestStorages...>
            : std::conditional<
                  TCurrentStorage::template storesAll<TComponentsTypeList>(),
                  TCurrentStorage, typename StorageSearch<TComponentsTypeList,
                                       TRestStorages...>::type>
        {
        };
