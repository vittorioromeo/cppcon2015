...
namespace ecs
{
    namespace Impl
    {
        ...
        // Contains helper functions to find storage specific to one or more
        // components.
        ...
        public:
            ...
            using ComponentTypes =
                MPL::Concat<typename TStorages::ComponentTypeList...>;
            ...
            static constexpr std::size_t componentCount{
                TypesConfig::componentCount};

        private:
            // Finds the storage designed to hold `TComponents`.
            template <typename... TComponents>
            using StorageFor =
                typename StorageSearch<MPL::TypeList<TComponents...>,
                    TStorages...>::type;

            // Returns true if a suitable storage for `TComponents` exists.
            template <typename... TComponents>
            static constexpr bool hasStorageFor{
                !std::is_same<StorageFor<TComponents...>, std::false_type>{}};
        ...
        public:
            ...
            {
                return getStorage<TComponents...>()
                    .getComponentTupleByDataIndex(mX);
            }
