    ...
    */
    ...
    namespace Impl
    {
        ...
        struct SignatureBitsets
        {
            ...
            using BitsetRepeatedList =
                MPL::Repeat<Settings::signatureCount(), Bitset>;
...
namespace tests
{
    ...
    static_assert(std::is_same<MySignatureBitsets::SignatureComponents<S0>,
                      ecs::MPL::TypeList<>>{},
        "");

    static_assert(std::is_same<MySignatureBitsets::SignatureComponents<S3>,
                      ecs::MPL::TypeList<C1, C3>>{},
        "");

    static_assert(std::is_same<MySignatureBitsets::SignatureTags<S3>,
